...
TextStyle ratingDarkHeadingText = GoogleFonts.poppins(
  fontSize: 24,
  fontWeight: FontWeight.w600,
  color: Colors.white,
);

TextStyle ratingDarkPriceText = GoogleFonts.poppins(
  fontSize: 20,
  color: Colors.white,
);

TextStyle ratingDarkChoiceText = GoogleFonts.poppins(
  fontSize: 18,
  color: Colors.white,
);
